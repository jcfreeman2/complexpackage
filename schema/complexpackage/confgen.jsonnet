// This is the configuration schema for complexpackage_gen

local moo = import "moo.jsonnet";
local s = moo.oschema.schema("dunedaq.complexpackage.confgen");
...
local cs = {
    ...
    complexpackage: s.record("complexpackage", [
	...
	s.field( "some_configured_value", self.int4, default=31415, doc="A value which configures the SomeDAQModule DAQModule instance"),
    ]),
